...
@interface DescriptorViewController ()

@end

@implementation DescriptorViewController
...
-(void) viewWillAppear:(BOOL)animated
{
	...
	[peripheral.peripheral readValueForDescriptor:descriptor];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	switch ( indexPath.row )
	{
		case 0:
			...
			cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", descriptor.UUID];
			break;
		case 1:
